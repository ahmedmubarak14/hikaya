...
export function ThemeToggle({ initial, labels }: Props) {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="grid h-9 w-9 place-items-center rounded-full border border-surface/15 text-surface/70 transition-colors hover:border-surface/40 hover:text-surface"
    >
